...
public class TestClient {
    public static void main(String args[]) throws Exception {
        try {
            ...
            int intSSLport = 9024; // Port where the SSL Server is listening
...
//            exp.printStackTrace();
    ...
    private static PublicKey getPubKeyFromKeyStore() throws Exception {
        ...
        InputStream ins = new FileInputStream("/home/philip/Desktop/Y2-S2/Security_in_Computing/Lab_sessions/Port/portecle-1.9/clientKS.jks");
